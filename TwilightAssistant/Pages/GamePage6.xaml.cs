...
public partial class GamePage6 : ContentPage
{
    ...
    public GamePage6(GamePageViewModel gpvm, GameServices gs, IDispatcher dispatcher)
    {
        //ViewModel
        ...
        playerTime3.Text = Tick.TickLogic(tickArray[0, 0], tickArray[0, 1], tickArray[0, 2]);
        playerTime4.Text = Tick.TickLogic(tickArray[1, 0], tickArray[1, 1], tickArray[1, 2]);
        playerTime5.Text = Tick.TickLogic(tickArray[2, 0], tickArray[2, 1], tickArray[2, 2]);
        playerFrame0.BorderColor = Colors.Gray;
        playerFrame1.BorderColor = Colors.Gray;
        playerFrame2.BorderColor = Colors.Gray;
        playerFrame3.BorderColor = Colors.Gray;
        playerFrame4.BorderColor = Colors.Gray;
        playerFrame5.BorderColor = Colors.Gray;
        ...
        */
        ...
        timer3.Tick += (s, e) =>
        {
            ...
            playerTime3.Text = Tick.TickLogic(tickArray[3, 0], tickArray[3, 1], tickArray[3, 2]);
        };
        ...
        timer4.Tick += (s, e) =>
        {
            ...
            playerTime4.Text = Tick.TickLogic(tickArray[4, 0], tickArray[4, 1], tickArray[4, 2]);
        };
        ...
        timer5.Tick += (s, e) =>
        {
            ...
            playerTime5.Text = Tick.TickLogic(tickArray[5, 0], tickArray[5, 1], tickArray[5, 2]);
        };
            ...
            case "StartBtn3":
                {
                    ...
                    playerFrame3.BorderColor = Colors.DarkGreen;
                    break;
                }
            case "StartBtn4":
                {
                    ...
                    playerFrame4.BorderColor = Colors.DarkGreen;
                    break;
                }
            case "StartBtn5":
                {
                    ...
                    playerFrame5.BorderColor = Colors.DarkGreen;
                    break;
                }
            default:
                break;
